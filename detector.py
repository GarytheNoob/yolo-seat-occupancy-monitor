...
PERSON_CLASS = 0
ITEM_CLASSES = {24: "Backpack", 26: "Handbag", 28: "Suitcase", 63: "Laptop", 73: "Book"}
        ...
        for result in results:
            ...
            for box in boxes:
                ...
                # Filter for item classes if enabled
                    ...
                    self.detect_items
                    and class_id in ITEM_CLASSES
                    and confidence >= self.item_confidence_threshold
                ):
